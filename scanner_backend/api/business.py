...
from scanner_backend.api.parsers import SearchInitiativeParser
...
def get_initiative_types():
    itm = im('scanner_backend.api.managers.{}.initiative_type'.format(Config.COUNTRY))
    return itm.InitiativeTypeManager().get_values()

def get_initiative_status():
    ism = im('scanner_backend.api.managers.{}.initiative_status'.format(Config.COUNTRY))
